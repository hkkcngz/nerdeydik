...
<article id="post-<?php the_ID(); ?>" <?php post_class('article-item '); ?>>
    ...
    <a class="image status" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
        <?php if ( has_post_thumbnail() ) { ?>
            <img src="<?php echo get_the_post_thumbnail_url(); ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy">
        <?php }
        echo "<p><b>" . get_the_title() . "</b></p><br>"; 
        the_excerpt(); ?>
    </a>
